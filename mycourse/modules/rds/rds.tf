resource "aws_db_instance" "course1" {
  ...
  option_group_name               = var.enable_option_group ? aws_db_option_group.db_option_group[0].id : ""
...
resource "aws_db_option_group" "db_option_group" {
  ...
  name                 = "${var.option_prefix}-${var.primary_name}-${var.environment}"
...
resource "aws_db_instance_role_association" "example" {
  ...
  db_instance_identifier = aws_db_instance.course1[count.index].id
